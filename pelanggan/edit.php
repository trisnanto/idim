                ...
                <div class="row">
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input type="text" name="nama_depan" class="form-control" id="nama-depan" value="<?php echo $pelangganTerpilih['NamaDepan'] ?>">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="mb-3">
                      <label for="nama-belakang" class="form-label">Nama Belakang</label>
                      <input type="text" name="nama_belakang" class="form-control" id="nama-belakang" value="<?php echo $pelangganTerpilih['NamaBelakang'] ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input type="text" name="no_hp" class="form-control" id="no-hp" value="<?php echo $pelangganTerpilih['NoHp'] ?>">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="mb-3">
                      <label for="alamat" class="form-label">Alamat</label>
                      <input type="text" name="alamat" class="form-control" id="alamat" value="<?php echo $pelangganTerpilih['Alamat'] ?>">
                    </div>
                  </div>
                </div>
