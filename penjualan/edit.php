                ...
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="mb-3">
                      ...
                      <input type="text" name="jumlah_penjualan" class="form-control" id="jumlah-penjualan" value="<?php echo $penjualanTerpilih['JumlahPenjualan'] ?>">
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="mb-3">
                      <label for="harga-jual" class="form-label">Harga Jual</label>
                      <input type="text" name="harga_jual" class="form-control" id="harga-jual" value="<?php echo $penjualanTerpilih['HargaJual'] ?>">
                    </div>
                </div>
